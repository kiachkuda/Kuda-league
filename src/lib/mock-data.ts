...
export interface Team {
  ...
  baseFans: number; // historic fan base, added to live signups
}
...
export const teams: Team[] = [
  { id: "t1", name: "Phoenix Vanguard", short: "PHX", logo: "🔥", color: "from-orange-500 to-red-600", captain: "Marcus Vale", founded: 2018, played: 14, wins: 11, draws: 2, losses: 1, gf: 38, ga: 12, form: ["W","W","W","D","W"], description: "Reigning champions known for relentless attacking football.", roster: [{name:"Marcus Vale",role:"Captain / FW",number:9},{name:"Eli Rhodes",role:"MF",number:8},{name:"Kade Brooks",role:"DF",number:4},{name:"Theo Ng",role:"GK",number:1}], socials: { twitter: "@phx" }, baseFans: 28400 },
  { id: "t2", name: "Iron Wolves", short: "IRW", logo: "🐺", color: "from-slate-400 to-slate-700", captain: "Dimitri Volkov", founded: 2015, played: 14, wins: 10, draws: 2, losses: 2, gf: 32, ga: 14, form: ["W","L","W","W","W"], description: "Defensive titans with unmatched tactical discipline.", roster: [{name:"Dimitri Volkov",role:"DF",number:5},{name:"Sami Reyes",role:"MF",number:10}], socials: {}, baseFans: 22100 },
  { id: "t3", name: "Neon Strikers", short: "NEO", logo: "⚡", color: "from-cyan-400 to-blue-600", captain: "Jin Park", founded: 2020, played: 14, wins: 9, draws: 3, losses: 2, gf: 30, ga: 16, form: ["W","D","W","W","D"], description: "Fast-paced playstyle powered by next-gen youth.", roster: [{name:"Jin Park",role:"FW",number:7}], socials: {}, baseFans: 19850 },
  { id: "t4", name: "Crimson Royals", short: "CRR", logo: "👑", color: "from-rose-500 to-pink-700", captain: "Leo Marchetti", founded: 2012, played: 14, wins: 8, draws: 2, losses: 4, gf: 27, ga: 18, form: ["L","W","W","D","W"], description: "Veteran squad with legendary tournament history.", roster: [{name:"Leo Marchetti",role:"MF",number:10}], socials: {}, baseFans: 17600 },
  { id: "t5", name: "Galactic FC", short: "GAL", logo: "🪐", color: "from-violet-500 to-purple-700", captain: "Nova Chen", founded: 2019, played: 14, wins: 7, draws: 3, losses: 4, gf: 24, ga: 20, form: ["D","W","L","W","W"], description: "Creative midfield, unpredictable counter-attacks.", roster: [{name:"Nova Chen",role:"MF",number:6}], socials: {}, baseFans: 14200 },
  { id: "t6", name: "Apex Predators", short: "APX", logo: "🦅", color: "from-amber-400 to-orange-600", captain: "Rafael Cruz", founded: 2017, played: 14, wins: 6, draws: 4, losses: 4, gf: 22, ga: 21, form: ["D","D","W","L","W"], description: "Balanced squad with strong away record.", roster: [{name:"Rafael Cruz",role:"FW",number:11}], socials: {}, baseFans: 11500 },
  { id: "t7", name: "Storm Breakers", short: "STB", logo: "🌀", color: "from-sky-400 to-indigo-600", captain: "Yuki Tanaka", founded: 2021, played: 14, wins: 5, draws: 3, losses: 6, gf: 19, ga: 23, form: ["L","W","D","L","W"], description: "Rising stars chasing their first trophy.", roster: [{name:"Yuki Tanaka",role:"MF",number:14}], socials: {}, baseFans: 8400 },
  { id: "t8", name: "Titan Legion", short: "TTN", logo: "⚔️", color: "from-emerald-400 to-teal-700", captain: "Aria Solis", founded: 2014, played: 14, wins: 2, draws: 2, losses: 10, gf: 11, ga: 35, form: ["L","L","L","D","L"], description: "Rebuilding season with focus on youth development.", roster: [{name:"Aria Solis",role:"DF",number:3}], socials: {}, baseFans: 6750 },
];
